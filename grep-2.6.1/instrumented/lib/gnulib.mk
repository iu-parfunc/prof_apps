...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libgreputils --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=gnulib-tests --aux-dir=build-aux --with-tests --no-libtool --macro-prefix=gl alloca announce-gen atexit binary-io btowc closeout dirent dirname do-release-commit-and-tag error exclude fcntl-h fnmatch getopt-gnu getpagesize gettext git-version-gen gitlog-to-changelog gnu-web-doc-update gnupload hard-locale ignore-value intprops isdir locale lseek maintainer-makefile malloc manywarnings mbrlen mbrtowc memchr mempcpy obstack open progname quotearg realloc regex ssize_t stddef stdlib stpcpy strerror string strtol strtoul strtoull strtoumax sys_stat unistd unlocked-io update-copyright useless-if-before-free wchar wcrtomb wctob wctype xalloc xstrtoumax
