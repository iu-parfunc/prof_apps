...
EXTRA_DIST += test-dirent.c test-dirent-c++.cc signature.h
...
EXTRA_libtests_a_SOURCES += imaxtostr.c inttostr.c offtostr.c uinttostr.c umaxtostr.c
...
EXTRA_DIST += test-langinfo.c test-langinfo-c++.cc signature.h
...
EXTRA_DIST += test-locale.c test-locale-c++.cc test-locale-c++2.cc signature.h
...
EXTRA_libtests_a_SOURCES += quote.c
...
EXTRA_DIST += test-stdlib.c test-stdlib-c++.cc test-stdlib-c++2.cc signature.h
...
EXTRA_DIST += test-string.c test-string-c++.cc test-string-c++2.cc signature.h
...
EXTRA_DIST += test-time.c test-time-c++.cc test-time-c++2.cc signature.h
...
EXTRA_DIST += test-wctype.c test-wctype-c++.cc signature.h macros.h
