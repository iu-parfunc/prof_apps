...
/* Define to 1 when using the gnulib module mbrlen. */
...
/* Define to 1 when using the gnulib module symlink. */
...
/* Define to 1 when using the gnulib module wctob. */
