...
#line 1 "./instrumented/./src/pcresearch.c"
...
__notify_intrinsic((void*)"void Pcompile(const char *, size_t) C_start", (void *)&global_x);
...
__notify_intrinsic((void*)"size_t Pexecute(const char *, size_t, size_t *, const char *) C_start", (void *)&global_x);
...
#line 108
{ size_t tau_ret_val =  -1; __notify_intrinsic((void*)"size_t Pexecute(const char *, size_t, size_t *, const char *) C_end", (void *)&global_x); return (tau_ret_val); }
