...
#line 670
{ off_t tau_ret_val =  FLUSH_BLOCK(1); __notify_intrinsic((void*)"deflate_fast:end", (void *)&global_x); return (tau_ret_val); }
...
#line 679
{
    ...
    if (compr_level <= 3) 
#line 686
{ off_t tau_ret_val =  deflate_fast(); __notify_intrinsic((void*)"deflate:end", (void *)&global_x); return (tau_ret_val); }
...
#line 777
{ off_t tau_ret_val =  FLUSH_BLOCK(1); __notify_intrinsic((void*)"deflate:end", (void *)&global_x); return (tau_ret_val); }
