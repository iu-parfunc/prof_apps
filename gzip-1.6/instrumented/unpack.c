...
__notify_intrinsic((void*)"read_byte:start", (void *)&global_x);
...
#line 86
{ unsigned char tau_ret_val =  b; __notify_intrinsic((void*)"read_byte:end", (void *)&global_x); return (tau_ret_val); }
