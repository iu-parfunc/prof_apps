...
__notify_intrinsic((void*)"read_buffer:start", (void *)&global_x);
...
#line 163
{ int tau_ret_val =  len; __notify_intrinsic((void*)"read_buffer:end", (void *)&global_x); return (tau_ret_val); }
...
__notify_intrinsic((void*)"write_buffer:start", (void *)&global_x);
...
#line 175
{ int tau_ret_val =  write (fd, buf, cnt); __notify_intrinsic((void*)"write_buffer:end", (void *)&global_x); return (tau_ret_val); }
...
__notify_intrinsic((void*)"gzip_base_name:start", (void *)&global_x);
...
#line 261
{ char * tau_ret_val =  fname; __notify_intrinsic((void*)"gzip_base_name:end", (void *)&global_x); return (tau_ret_val); }
...
__notify_intrinsic((void*)"xunlink:start", (void *)&global_x);
...
#line 286
{ int tau_ret_val =  r; __notify_intrinsic((void*)"xunlink:end", (void *)&global_x); return (tau_ret_val); }
...
#line 366
{ char * tau_ret_val =  env_val; __notify_intrinsic((void*)"add_envopt:end", (void *)&global_x); return (tau_ret_val); }
...
__notify_intrinsic((void*)"gzip_error:start", (void *)&global_x);
...
__notify_intrinsic((void*)"xalloc_die:start", (void *)&global_x);
...
__notify_intrinsic((void*)"warning:start", (void *)&global_x);
...
__notify_intrinsic((void*)"fprint_off:start", (void *)&global_x);
