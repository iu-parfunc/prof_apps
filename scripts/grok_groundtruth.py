...
def main():
  ...
  rounds = ['1', '2', '3']
  heavy_hitters = {'h264ref-9.3' : ['FastLine16Y_11','FastPelY_14','PutPel_14', 'SATD', 'UMVLine16Y_11', 'UMVPelY'],
  ...
  RESULTS = "/u/crest-team/working_copies/onlineProfiling/groundtruth"
  ...
  with cd(RESULTS):
	...
	min_times = []
        for round in rounds:
          sample_file = "prof-swarm-" + bench + "-" + round + "-" + heavy_hitter + ".out"
	  print "Processing %s..\n" % sample_file 
